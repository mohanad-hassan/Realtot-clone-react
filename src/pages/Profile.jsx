        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form >
            ...
            <input
              ...
              onChange = {onChange}
              disabled = {!edit}
              className={`mb-6 w-full px-4 py-2 text-xl text-gray-700 border border-gray-300 rounded transition ease-in-out ${edit&& 'bg-red-400 text-white'}
                 `}
            />
